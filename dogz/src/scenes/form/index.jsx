...
const FormTutor = () => {
  ...
  */
  ...
  return (
    <Box m="20px">
      <Header title="Cadastro de Tutor e pets" subtitle="Cadastre um novo tutor e seus pets" />
        ...
        {({
          ...
          <Form>
            ...
            >
              ...
              <FieldArray
                name="pets"
                render={(arrayHelpers) => values.pets && values.pets.length > 0 ?
                  values.pets.map((pet, index) => (
                    <Box key={index}>
                      <PetForm name={`pets.${index}`} />
                      <Box display="flex" justifyContent="start" mt="20px">
                        <Button color="secondary" variant="contained" onClick={() => arrayHelpers.push({
                          nomePets: "",
                          apelido: "",
                          raca: "",
                          cor: "",
