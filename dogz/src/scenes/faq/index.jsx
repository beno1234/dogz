...
const FormTutor = () => {
  ...
  */
  ...
  return (
    <Box m="20px">
      <Header title="Cadastro de Planos / Serviços" subtitle="Cadastre serviços e planos necessarios." />
          ...
          <Form>
            ...
            >
              ...
              <Field
                ...
                className={`custom-select ${touched.id_tutor && errors.id_tutor ? "error-field" : ""}`}
                error={errors.id_tutor && touched.id_tutor && <div className="error-message">{errors.id_tutor}</div>}
              >
                {users.map(user => (
...
const checkoutSchema = yup.object().shape({
  ...
  valor_mensal: yup.string(),
  servicos_avulsos: yup.string(),
  id_tutor: yup.string().required("Selecione um tutor"),
