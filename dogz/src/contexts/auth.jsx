...
import { api, CreateService, createSession, CreateTutorPets, getTutor, getUser } from "../services/api";
...
export const AuthProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ authenticated: !!user, user, loading, login, logout, isLoggedIn, tutor, service }}>
            {children}
